	...
	<div id="header"><!-- 상단 -->
		...
		<div id="contents"><!--내용-->
			...
			<ul class="basic_list">
				...
				<li><span>&#47; 출금계좌번호</span><input type="text" class="wr_account" placeholder="2354-258-25891" /><a href="#" onclick="window.open('loan_pop.action','pop','resizable=no scrollbars=yes top=300 left=500 width=500 height=300');return false">조회</a></li>
				<li><span>&#47; 상환금액</span><input type="text" class="wr_account" /></li>
			</ul>

			<p class="list_btn">
				<a href="page/haveaccount.action">이전</a><a href="#" class="select">대출상환</a>
			</p>
